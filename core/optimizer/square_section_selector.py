...
def run_square_section_search(
    ...
    *,
    ...
    selection["search_policy"] = (
        ...
        "engineering estimates and similar-job cache entries cannot skip or add candidates, while post-failure "
        "section-modulus jumps may skip only under-sized failed candidates inside that list. "
